import {
  ...
  Vector4,
  VectorKeyframeTrack,
} from "https://cdn.jsdelivr.net/npm/three@0.146.0/build/three.module.js";

import { NURBSCurve } from "/5/test3D/lib/NURBSCurve.js";
import * as fflate from "/5/test3D/lib/fflate.module.js";
...
class FBXTreeParser {
  ...
  parseParameters(materialNode, textureMap, ID) {
    ...
    if (materialNode.Specular) {
      parameters.specular = ColorManagement.toWorkingColorSpace(
        new Color().fromArray(materialNode.Specular.value),
        SRGBColorSpace
      );
    } else if (
      ...
      parameters.specular = ColorManagement.toWorkingColorSpace(
        new Color().fromArray(materialNode.SpecularColor.value),
        SRGBColorSpace
      );
    }
